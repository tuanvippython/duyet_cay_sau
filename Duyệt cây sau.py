...
#right là cây con bên phải
    #Tạo hàm duyệt sau
    def duyet_LRN(self, current_node=None):
...
print(node.duyet_LRN())
# Kết quả sẽ hiển thị là: [4,5,2,3,1]
